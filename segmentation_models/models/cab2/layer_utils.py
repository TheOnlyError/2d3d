    ...
    for i in range(stack_num):
        ...
        if kernel_size >= 3:
            ...
            if direction_aware:
                ...
                #     else:
                #         d1_conv = tfa.layers.GroupNormalization(axis=3, groups=groups, name='d1_{}_{}_gn'.format(name, i))(
                #             d1_conv)
                #         d2_conv = tfa.layers.GroupNormalization(axis=3, groups=groups, name='d2_{}_{}_gn'.format(name, i))(
                #             d2_conv)
                out += d1_conv + d2_conv
