...
from segmentation_models.models.ours_multi.layer_utils import CONV_stack, CONV_output, decode_layer, encode_layer
...
def UNET_right(X, X_list, channel, kernel_size=3,
               ...
               unpool=False, batch_norm=False, concat=True, name='right0'):
    '''
