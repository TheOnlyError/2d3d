...
if __name__ == '__main__':
    ...
    files = os.listdir('qualitative')
    for file in files:

        image = cv2.imread('qualitative/' + file)
        ...
        results = post_process(rgb2ind(image), eval=True, high_res=True, debug=True)
        resized_results = []
        ...
        write('qualitative/pp_' + file, resized_results[0])
